-- ============================================================
-- FACT_RIDE
-- One row per trip. FKs to DIM_STATION and DIM_DATES.
-- ============================================================
 
CREATE TABLE IF NOT EXISTS CITIBIKE_SYSTEM_DATA.INT_UDM_NYC.FACT_RIDE (
...
COMMENT = 'Fact table — one row per NYC Citi Bike ride. Clustered by date for time-range query performance.';