CREATE TABLE IF NOT EXISTS CITIBIKE_SYSTEM_DATA.INT_UDM_NYC.DIM_STATION (
...
COMMENT = 'Station dimension for NYC. One row per unique physical station resolved by canonical name. Populated by SP_BUILD_DIM_STATION_NYC.';